<div class="bd-b-one bd-c-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Update Service Order') }}</h2>
    <div class="mClose">
        <button type="button"
...
<form class="ajax reset" action="{{ route('admin.service_orders.store', encodeId($serviceOrder->id)) }}" method="post"
