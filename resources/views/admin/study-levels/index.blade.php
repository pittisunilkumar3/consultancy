...
@section('content')
    ...
    <div class="p-sm-30 p-15">
        <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            <div class="">
                <table class="table zTable zTable-last-item-right pt-15" id="studyLevelDataTable">
                    <thead>
                        <tr>
                            <th>
                                <div>{{ __('Name') }}</div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div class="bd-b-one bd-c-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
                    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Add Study Level') }}</h2>
                    <div class="mClose">
                        <button type="button"
                ...
                <form class="ajax reset" action="{{ route('admin.study_levels.store') }}" method="post"
                    ...
                    <div class="row rg-20 mb-20">
                        <div class="col-12">
                            <label for="name" class="zForm-label-alt">{{ __('Name') }}</label>
                            <input type="text" name="name" class="form-control zForm-control-alt" id="name"
                                   placeholder="{{ __('Name') }}" />
                        </div>
                        <div class="col-md-12">
    ...
    <input type="hidden" id="studyLevelIndexRoute" value="{{ route('admin.study_levels.index') }}">
@endsection

@push('script')
    <script src="{{ asset('admin/custom/js/study-levels.js') }}"></script>
@endpush
