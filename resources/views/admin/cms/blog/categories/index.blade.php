...
@section('content')
        ...
        <div class="row rg-20">
            <div class="col-xl-12">
                <div class="align-items-center bd-b-one bd-c-one bd-c-stroke bd-c-stroke-2 d-flex justify-content-between mb-30 pb-15 pb-sm-30">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#add-modal" class="flipBtn sf-flipBtn-primary flex-shrink-0">+ {{__('Add Blog Category')}}</button>
                </div>
                <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
                    <div class="">
                        <table class="table zTable zTable-last-item-right pt-15" id="blogCategoryDataTable">
                            <thead>
                            <tr>
                                <th><div>{{__('Sl')}}</div></th>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div class="bd-b-one bd-c-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
                    <h2 class="fs-18 fw-600 lh-22 text-title-black">{{ __('Add Blog Category') }}</h2>
                    <div class="mClose">
                        <button type="button"
                ...
                <form class="ajax reset" action="{{ route('admin.cms-settings.blogs.categories.store') }}" method="post"
    ...
    <input type="hidden" id="blog-categories-route" value="{{ route('admin.cms-settings.blogs.categories.index') }}">

    <!-- Edit Modal section end -->
@endsection
@push('script')
    <script src="{{asset('admin/custom/js/cms/blog-categories.js')}}"></script>
@endpush
