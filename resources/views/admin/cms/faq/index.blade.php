...
@section('content')
        ...
        <div class="row rg-20">
            ...
            <div class="col-xl-9">
                <div class="align-items-center bd-b-one bd-c-one bd-c-stroke bd-c-stroke-2 d-flex justify-content-between mb-30 pb-15 pb-sm-30">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#add-modal" class="flipBtn sf-flipBtn-primary flex-shrink-0">+ {{__('Add Faq')}}</button>
                </div>
                <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
                    <div class="">
                        <table class="table zTable zTable-last-item-right pt-15" id="faqDataTable">
                            <thead>
                            <tr>
                                <th><div>{{__('Sl')}}</div></th>
                                <th><div>{{__('Question')}}</div></th>
                                <th><div>{{__('Answer')}}</div></th>
    ...
    <div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                ...
                <form class="ajax reset" action="{{ route('admin.cms-settings.faqs.store') }}" method="post"
                    ...
                    <div class="row rg-20">
                        <div class="">
                            ...
                            <input type="text" name="question" id="question" placeholder="{{ __('Type Question') }}"
                                   class="form-control zForm-control-alt">
                        </div>
                        <div class="">
                            <label for="symbol" class="zForm-label-alt">{{ __('Answer') }} <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="answer" id="answer" placeholder="{{ __('Type Answer') }}"
                                   class="form-control zForm-control-alt">
                        </div>
                        <div class="">
    ...
    <input type="hidden" id="faq-route" value="{{ route('admin.cms-settings.faqs.index') }}">

    <!-- Edit Modal section end -->
@endsection
@push('script')
    <script src="{{asset('admin/custom/js/cms/faqs.js')}}"></script>
@endpush
