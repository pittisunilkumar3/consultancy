...
@section('content')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div
                    ...
                    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Add Student') }}</h2>
                    <div class="mClose">
                        <button type="button"
                ...
                <form class="ajax reset" action="{{ route('admin.students.store') }}" method="post"
    ...
    <input type="hidden" id="student-route" value="{{ route('admin.students.index') }}">

    <!-- Edit Modal section end -->
@endsection
@push('script')
    <script src="{{asset('admin/custom/js/students.js')}}"></script>
@endpush
