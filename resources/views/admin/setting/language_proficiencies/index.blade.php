...
@section('content')
        ...
        <div class="row rg-20">
            ...
            <div class="col-xl-9">
                ...
                <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
                    <table class="table zTable zTable-last-item-right" id="languageProficiencyDataTable">
                        <thead>
                            <tr>
                                <th>
                                    <div>{{ __('Title') }}</div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div class="bd-b-one bd-c-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
                    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Add Language Proficiency Test') }}</h2>
                    <div class="mClose">
                        <button type="button"
    ...
    <input type="hidden" id="designationIndexRoute" value="{{ route('admin.setting.language_proficiencies.index') }}">
@endsection

@push('script')
    <script src="{{ asset('admin/custom/js/language_proficiencies.js') }}"></script>
@endpush
