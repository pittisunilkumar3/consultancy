...
<div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
    <div class="">
        ...
        <div class="row rg-20">
            ...
            <div class="col-xl-9">
                <div class="bg-white p-sm-25 p-15 bd-one bd-c-stroke bd-ra-8">
                    <h4 class="fs-18 fw-600 lh-22 text-title-text bd-b-one bd-c-stroke mb-25 pb-25">{{ $pageTitle }}</h4>
                    <div class="">
                        <h5 class="fs-16 fw-600 lh-22 text-title-text pb-10">{{ __('Instructions') }}: </h5>
                        ...
                        <div class="text-black mt-3">
                            <a href="{{ route('admin.setting.storage.link') }}"
                                class="flipBtn sf-flipBtn-primary d-inline-block">
                                {{ __('Storage Link') }}</a>
                        </div>
                    </div>
                    <form class="ajax" action="{{ route('admin.setting.storage.update') }}" method="POST"
                        ...
                        <div class="d-flex flex-column rg-20">
                            ...
                            <div class="d-none storage-driver" id="aws">
                                <div class="row rg-20">
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('AWS Access Key ID') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="AWS_ACCESS_KEY_ID"
                                            value="{{ env('AWS_ACCESS_KEY_ID') }}" class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('AWS Secret Access Key') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('AWS Default Region') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="AWS_DEFAULT_REGION"
                                            value="{{ env('AWS_DEFAULT_REGION') }}" class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('AWS Bucket') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="d-none storage-driver" id="wasabi">
                                <div class="row rg-20">
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('WAS Access Key ID') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('WAS Secret Access Key') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('WAS Default Region') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('WAS Bucket') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="d-none storage-driver" id="vultr">
                                <div class="row rg-20">
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('VULTR Access Key') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="VULTR_ACCESS_KEY_ID"
                                            value="{{ env('VULTR_ACCESS_KEY') }}" class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('VULTR Secret Key') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="VULTR_SECRET_ACCESS_KEY"
                                            value="{{ env('VULTR_SECRET_KEY') }}" class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('VULTR Region') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="VULTR_DEFAULT_REGION" value="{{ env('VULTR_REGION') }}"
                                            class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('VULTR Bucket') }} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="d-none storage-driver" id="do">
                                <div class="row rg-20">
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('DO Access Key ID') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="DO_ACCESS_KEY_ID" value="{{ env('DO_ACCESS_KEY_ID') }}"
                                            class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('DO Secret Access Key') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('DO Default Region') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="DO_DEFAULT_REGION"
                                            value="{{ env('DO_DEFAULT_REGION') }}" class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('DO Bucket') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="DO_BUCKET" value="{{ env('DO_BUCKET') }}"
                                            class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('DO Folder') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="DO_FOLDER" value="{{ env('DO_FOLDER') }}"
                                            class="form-control zForm-control-alt">
                                    </div>
                                    <div class="col-xxl-4 col-lg-6">
                                        <label class="zForm-label-alt">{{ __('DO CDN ID') }} <span
                                                class="text-danger">*</span></label>
...
@endsection
@push('script')
<script src="{{ asset('admin/custom/js/storage-settings.js') }}"></script>
@endpush
