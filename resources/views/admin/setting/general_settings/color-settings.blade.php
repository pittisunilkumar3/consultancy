                        ...
                        <form class="ajax" action="{{ route('admin.setting.application-settings.update') }}"
                            ...
                            <div class="row rg-20 {{getOption('app_color_design_type', DEFAULT_COLOR) == DEFAULT_COLOR ? 'd-none' : ''}}" id="custom-color-block">
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    ...
                                    <input type="color" name="primary_color" value="{{ getOption('primary_color','#000064') ?? '#000064' }}"
                                           class="form-control zForm-control-alt p-8">
                                </div>
                                <div class="col-xxl-4 col-lg-6">
                                    <label class="zForm-label-alt">{{ __('Secondary Color') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="color" name="secondary_color" value="{{ getOption('secondary_color','#fb5421') ?? '#fb5421' }}"
                                           class="form-control zForm-control-alt p-8">
                                </div>
                                <div class="col-xxl-4 col-lg-6">
                                    <label class="zForm-label-alt">{{ __('Sidebar Color') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="color" name="sidebar_color" value="{{ getOption('sidebar_color','#000064') ?? '#000064' }}"
                                           class="form-control zForm-control-alt p-8">
                                </div>
                                <div class="col-xxl-4 col-lg-6">
                                    <label class="zForm-label-alt">{{ __('Button Primary Color') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="color" name="button_primary_color" value="{{ getOption('button_primary_color','#f5dc3c') ?? '#f5dc3c' }}"
                                           class="form-control zForm-control-alt p-8">
                                </div>
                                <div class="col-xxl-4 col-lg-6">
                                    <label class="zForm-label-alt">{{ __('Button Secondary Color') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="color" name="button_secondary_color" value="{{ getOption('button_secondary_color','#000064') ?? '#000064' }}"
                                           class="form-control zForm-control-alt p-8">
                                </div>
                                <div class="col-xxl-4 col-lg-6">
                                    <label class="zForm-label-alt">{{ __('Title Text Color') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="color" name="title_text_color" value="{{ getOption('title_text_color','#121d35') ?? '#121d35' }}"
                                           class="form-control zForm-control-alt p-8">
                                </div>
                                <div class="item-top">
                                    <hr>
