<div class="invoice-content">
    <div class="bd-b-one bd-c-stroke pb-25 mb-25 d-flex justify-content-between align-items-center flex-wrap">
        ...
        <!--  -->
        <a target="blank" href="{{route(getPrefix().'.transactions.print', encodeId($transaction->id))}}"
        ...
        <ul class="zList-pb-15">
            <li>
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <p class="fs-14 fw-600 lh-17 text-title-text">{{showPrice($transaction->amount)}}</p>
                    </div>
                </div>
            </li>
        </ul>
