        ...
        <div class="row rg-20">
                    ...
                    <ul class="zList-pb-5">
                        ...
                        <li class="d-flex g-8">
                            ...
                            <p class="fs-14 fw-500 lh-28 text-para-text d-flex g-5">
                                <span class="flex-shrink-0 text-title-text fw-600">{{__('Service Title')}} :</span>
                                {{ $serviceData->title }}
                            </p>
                        </li>
                        <li class="d-flex g-8">
                        ...
                        <li class="d-flex g-8">
                            ...
                            @if($serviceData->status == STATUS_ACTIVE)
                                <p class="fs-14 fw-500 lh-28 text-para-text d-flex g-5">
                                    <span class="flex-shrink-0 text-title-text fw-600">{{__('Status')}} :</span>
                                    {{__('Active')}}
                                </p>
                        ...
                        <li class="d-flex g-8">
                            ...
                            <p class="fs-14 fw-500 lh-28 text-para-text d-flex g-5">
                                <span class="flex-shrink-0 text-title-text fw-600">{{__('Created At')}} :</span>
                                {{ \Carbon\Carbon::parse($serviceData->created_at)->format('Y-m-d , h:i:s') }}
                            </p>
                        </li>
                            ...
                            @foreach($serviceData->feature as $feature)
                                <li class="item">
                                    <div class="d-flex g-8">
                                        ...
                                        <p class="fs-14 fw-500 lh-28 text-para-text d-flex g-5">
                                            <span class="flex-shrink-0 text-title-text fw-600">{{$feature['name']}} :</span>
                                            {{$feature['value']}}
                                        </p>
                                    </div>
                                </li>
            ...
            <div class="col-xll-10 col-lg-7 col-md-6">
                <div class="event-details-content">
                    <div class="img"><img src="{{ getFileUrl($serviceData->image) }}" alt=""/></div>
                    <div class="mb-20">
                        {!! $serviceData->description !!}
                    </div>
                    <div class="">
                        <a href="{{ route('student.checkout',['type'=>'service','slug' => $serviceData->slug]) }}"
                           class="flipBtn sf-flipBtn-primary flex-shrink-0">{{__('Checkout')}}</a>
                    </div>
                </div>
            </div>
        </div>
