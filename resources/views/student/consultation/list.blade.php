...
@section('content')
    <div class="px-sm-30 p-15 bd-b-one bd-c-stroke-2 d-flex justify-content-between align-items-center">
        ...
        <div class="search-one flex-grow-1 max-w-258">
            <input type="text" id="search-key" class="searchButtonConsultation"
    ...
    <div class="p-sm-30 p-15">
        <div class="p-sm-25 p-15 bd-one bd-c-stroke bd-ra-10 bg-white">
            <div class="">
                <table class="table zTable zTable-last-item-right pt-15" id="consultationDataTable">
                    <thead>
                    <tr>
                        <th>
                            <div>{{__('Consultant')}}</div>
                        </th>
                        <th>
    ...
    <input type="hidden" id="consultation-route" value="{{ route('student.consultation-appointment.list') }}">

@endsection
@push('script')
    <script src="{{asset('student/custom/js/consultation.js')}}"></script>
@endpush
