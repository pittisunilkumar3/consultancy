...
@section('content')
    ...
    <div class="p-sm-30 p-15" id="course-list-container">
        <!--  -->
        @include('student.my_courses.partials.course-list')
    </div>

    <input type="hidden" id="my-course-route" value="{{ url()->current() }}">

@endsection
@push('script')
    <script src="{{asset('student/custom/js/my_courses.js')}}"></script>
@endpush
